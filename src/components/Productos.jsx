  ...
  return (
    <div className='min-h-screenflex flex-col justify-center items-center lg:px-32 px-5 '>
      ...
      <div className='flex flex-wrap gap-8 justify-center'>
        <DishesCard img={img1} title="empanadas 12u" price="$10000" />
        <DishesCard img={img2} title="tequeños 12u" price="$6000" />
        <DishesCard img={img3} title="minitequeños 50u" price="$9000" />
        <DishesCard img={img4} title="combo tropical" price="$8000" />
        <DishesCard img={img5} title="salsa de ajo" price="$1000" />
        <DishesCard img={img6} title="torta 3 leches" price="$3500" />
      </div>
    </div>
  )
}
